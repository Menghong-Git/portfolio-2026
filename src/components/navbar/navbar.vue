  ...
  >
    ...
    <div class="w-full mx-auto flex items-center justify-between py-3 px-6">
      ...
      <div class="flex items-center gap-2 sm:gap-4">
        ...
        >
          <a v-for="social in socialIcons" :key="social.name" href="#" class="transition-all hover:scale-110"
    ...
    >
      ...
      >
        <div class="flex flex-col p-6 gap-6">
          ...
          >
            <a v-for="social in socialIcons" :key="social.name" href="#" class="transition-all transform hover:scale-110"
              :class="isDarkMode ? 'text-gray-400 hover:text-[#1dbf73]' : 'text-gray-600 hover:text-[#007BFE]'"
            >
